...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_ALT_RUN_DOWNSHIFT_TIME_MS, 3264);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_ALT_REST1_SAMPLE_TIME_MS, 20);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_EVT_RX_COUNT, 33);
